...
char read_buf[50];
fd=open("linux_kernel2.txt",O_CREAT | O_RDWR, 777);   //CFO
...
//changing current file offset position
lseek(fd,0,SEEK_SET);    //this lseek is operation to set the offset position and SEEK_SET is macro to set to begining
